...
int menu(int c1, int c2, int linha, int col) {
    ...
    do {
        if (pos == 1) {
            ...
            gotoxy(linha, col);
            printf(" %c Inserir cliente na lista   %c ", 16, 17);
        ...
        if (pos == 2) {
            ...
            gotoxy(linha + 1, col);
            printf(" %c Pesquisar pelo cpf do cliente %c ", 16, 17);

        } else {
            cor(c2);

            gotoxy(linha + 1, col);
            printf("   Pesquisar pelo cpf do cliente   ");
        }
        if (pos == 3) {
            cor(c1);

            gotoxy(linha + 2, col);
            printf(" %c Apagar cliente da lista %c ", 16, 17);
        ...
        if (pos == 4) {
            ...
            gotoxy(linha + 3, col);
            printf(" %c Mostrar todos os clientes  %c ", 16, 17);
        ...
        if (pos == 5) {
            ...
            gotoxy(linha + 4, col);
            printf(" %c Exportar clientes (txt)  %c ", 16, 17);

        } else {
            cor(c2);

            gotoxy(linha + 4, col);
            printf("   Exportar clientes (txt)   ");
        }
        if (pos == 6) {
            cor(c1);
            gotoxy(linha + 5, col);
