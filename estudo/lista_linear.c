...
// void Pesquisa(TipoItem item, TipoLista l) {
//     TipoApontador Aux = l.Primeiro->Prox;
//     int Encontrei = 0;
//     while (Aux->Prox != NULL) {
//         if (Aux->Item.Chave == item.Chave)
...
//     }
//     if (Encontrei)
//         printf("\nO Elemento %d está na Lista!", item.Chave);
//     else
//         printf("\nO Elemento %d não está na Lista!", item.Chave);
// }
...
//     while (p->Prox != NULL && p->Prox.Item != item) {
//         p = p->Prox;
//     }
